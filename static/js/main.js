...
const btnToggleAudio = document.querySelector('#audio-mute');
...
var btnSendMsg = document.querySelector('#send-message');
...
function createOfferer(peerUsername, receiver_channel_name){
    ...
    peer.addEventListener('icecandidate', (event)=>{
        if(event.candidate){
            console.log('New ice camdidate :', JSON.stringify(peer.localDescription));
            return ;
